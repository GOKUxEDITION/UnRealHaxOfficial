...
bot = telebot.TeleBot('7867146242:AAHoidrdjEgktCG7b0NbMTerKZNlj6GAQfM')

# Admin user IDs
admin_id = {"7703018672", "6865441058", "7136384960"}
...
def handle_aadi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - @II_MR_PSYCHO_1 @UnRealHaxOwner ."
